            ...
            <div class="bloc">
                <div class="title">
                    产品明细<div style="float: right; margin-right: 30px;">
                        <input id="btn_refresh" class="barbtn" onclick="javascript: location.reload();" type="button" value="刷新" /><input id="btn_new" style="margin-right: 10px;" type="button" value="新增" onclick="javascript: OpenWindow('AddComponent.aspx', '新增产品');" /><asp:Button ID="deleteBtn" runat="server" Text="删除" OnClick="deleteBtn_Click" />
                    </div>
                </div>
                <div class="content">
                    <table>
                        <asp:Repeater ID="myRepeat" runat="server">
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="actions" style="text-align: left"><a href="javascript:OpenWindow('ViewPage.aspx?filename=/json/components/component<%#Eval("id") %>.json','chart');" title="预览">
                                        <img src="img/th-comment.png" alt="" /></a>
                                        <a href="javascript: OpenWindow('AddComponent.aspx?id=<%#Eval("id") %>', '编辑产品');" title="编辑">
