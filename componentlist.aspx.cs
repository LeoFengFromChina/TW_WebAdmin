...
public partial class componentlist : BaseForm
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
           ...
           // deleteBtn.Attributes.Add("OnClick", "return  del_sure()");
            ...
            List<ComponentList> pls = GetJsonToObject<List<ComponentList>>(jpath);
    ...
    protected void deleteBtn_Click(object sender, EventArgs e)
    {
        ...
        //保存修改
        string s2 = JsonSerializer<List<ComponentList>>(pls);
