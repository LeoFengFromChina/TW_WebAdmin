<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeFile="AddSolution.aspx.cs" Inherits="AddSolution" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div>所属城市：<asp:DropDownList ID="ddl_city" runat="server">
